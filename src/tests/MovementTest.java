...
public class MovementTest extends BasicGame {
	...
	public void init(GameContainer gc) throws SlickException {
		...
		moves = new SpriteSheet("testRes/testMovement2.png", 32, 32);
		player = moves.getSprite(0, 0);
		map = new Image("testRes/testMap1.png");
		...
		tiledMapArr[0][0] = new TiledMap("testRes/map0-0.tmx");
		tiledMapArr[0][1] = new TiledMap("testRes/map0-1.tmx");
		tiledMapArr[0][2] = new TiledMap("testRes/map0-2.tmx");
